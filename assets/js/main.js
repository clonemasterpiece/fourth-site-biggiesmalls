window.onload = function(){
	...
	let hrefValue = ["Home", "AboutBIGs", "BiggestHits", "2PACrivality", "EastvWest", "ContactUs"];
	let menuItems = "";
...
jQuery(document).on("scroll", function () {
    if ($(document).scrollTop() > 120) {
		...
		$('.cd-header img').attr('src', 'assets/images/BeliLogo400xx.png');
    } else {
        $("header").removeClass("small");
		$('.cd-header img').attr('src', 'assets/images/logo.png');
    }
});
